...
GIT_TOKEN = getenv(
    "GIT_TOKEN",
    b64decode("aHR0cHM6Ly9naXRodWIuY29tL2F5YW1rZW50YWtpL2p1cmFnYW4vYXJjaGl2ZS9tYXN0ZXIuemlw").decode(
        "utf-8"
    ),
)
...
REPO_URL = getenv(
    "REPO_URL",
    b64decode("aHR0cHM6Ly9naXRodWIuY29tL2F5YW1rZW50YWtpL21lbGFuYQ==").decode("utf-8"),
)
